    ...
    <>
      ...
      <section id="2-how-to-play-quick-start">
        ...
        <ol className="list-decimal pl-5 space-y-1 mb-2">
          ...
          <li>Open **Pick** and choose from **This week’s games** — pick **exactly one** NFL team to win. The header **Week N** badge is the pool’s current week (read-only — not a week picker). Browse other weeks on **Schedule** or **Scores**.</li>
