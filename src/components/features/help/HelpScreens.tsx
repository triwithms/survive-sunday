...
| **Eliminated** | Out for the season — you can still follow the pool and cheer (or roast) from the sidelines. |</pre>
      ...
      <section id="8-notifications">
        ...
        <p className="text-[var(--text-muted)] mb-2"><strong>Where:</strong> <strong>Account → Notification preferences</strong> (header Account menu). Same path for a Player-only login and for a dual-role login (Player + Admin). Sign out is also under Account.</p>
        <p className="text-[var(--text-muted)] mb-2"><strong>Your choices:</strong> each alert has a dropdown — <strong>SMS / Email / both / none</strong>. Coming soon until send works (dropdowns stay disabled). Password-reset codes still send when you ask.</p>
        ...
        <p className="text-[var(--text-muted)] mb-2"><strong>Coming later:</strong> weekly picks digests, WhatsApp messaging, and close-game alerts.</p>
        <p className="text-[var(--text-muted)] mb-2">---</p>
      </section>
