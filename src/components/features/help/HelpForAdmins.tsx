    ...
    <>
      <section id="14-for-administrators">
        ...
        <ul className="list-disc pl-5 space-y-1 text-[var(--text-muted)] mb-2">
          <li className="text-[var(--text-primary)]"><strong>Share the Leaderboard or Scores (quiet):</strong> no Share button on the screen. Press and hold the page title, or tap the week label (gold <strong>Week N</strong>) three times → pick full long picture or a shorter option → Make picture → Save or Send. Click-by-click in <a href="#share-board-scores" className="text-gold-400">Share Leaderboard &amp; Scores</a>.</li>
          ...
          <li className="text-[var(--text-primary)]">**Roster:** open **Admin → Users** to see every nickname and real name, and fix nickname, full name, email, or cell if it’s wrong. Each change is audit-logged. You can also set <strong>Pick backup</strong> (off, optional copy-from-member if no pick within 30 minutes — no 💩 — or optional best unused 2025-rank team within about 2 minutes, which stamps 💩). Official winner must be 💩-free.</li>
