...
| **Eliminated** | Out for the season — you can still follow the pool and cheer (or roast) from the sidelines. |</pre>
      ...
      <section id="9-live-scores-digests">
        ...
        <p className="text-[var(--text-muted)] mb-2">Use the week dropdown (and arrows) to check past weeks. Live games show the <strong>quarter</strong> (Q1–Q4 or OT) and ESPN’s game clock next to the score when the feed has them — or ESPN’s short status (for example <strong>End of 2nd</strong> / <strong>Halftime</strong>) if the clock is missing. When ESPN has it, live games also show <strong>who has the ball</strong>, the <strong>down</strong>, and the <strong>yard line</strong> (for example <strong>KC ball · 2nd &amp; 7 · KC 33</strong>). Finals show <strong>Final</strong>. Upcoming games show today’s kickoff time (ET). Small team logos sit beside the abbreviations.</p>
