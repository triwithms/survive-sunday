...
| **Eliminated** | Out for the season — you can still follow the pool and cheer (or roast) from the sidelines. |</pre>
      ...
      <section id="8-notifications">
        ...
        <p className="text-[var(--text-muted)] mb-2"><strong>Where:</strong> <strong>Account (header) → Notification preferences</strong>. Same path for a Player-only login and for a dual-role login (for example Gams as Player + Admin). You can also open it from this Help page when you are signed in.</p>
      ...
      <section id="12-privacy-accounts">
        ...
        <ul className="list-disc pl-5 space-y-1 text-[var(--text-muted)] mb-2">
          ...
          <li className="text-[var(--text-primary)]">**Notification preferences:** <strong>Account (header) → Notification preferences</strong>. Save the toggles you want. Defaults are safe for friends (core on, noisy off).</li>
