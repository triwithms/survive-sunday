...
| **Eliminated** | Out for the season — you can still follow the pool and cheer (or roast) from the sidelines. |</pre>
      ...
      <section id="8-notifications">
        ...
        <p className="text-[var(--text-muted)] mb-2"><strong>Pick backup:</strong> Account → <strong>Pick backup</strong> (or Admin → Roster). Off by default. (1) Copy another member’s pick if you still have <strong>no pick</strong> within <strong>30 minutes</strong> of lock (Week 1: that pick’s kickoff) — JaJa copies Gams. (2) Or auto-pick the best remaining team by <strong>2025 rank #N</strong> (same prior-year composite Pick shows; 1 = strongest), skipping used teams and byes, if you still have none within <strong>about 2 minutes</strong> of lock. We never overwrite a pick you already submitted. Server jobs apply this — opening the app is not required.</p>
...
| Can’t change my pick | Weeks 2+ freeze at week lock. Week 1: you can still change until your pick’s kickoff, but only onto a game that has not started. |`}</pre>
      ...
      <section id="14-for-commissioners-admins">
        ...
        <ul className="list-disc pl-5 space-y-1 text-[var(--text-muted)] mb-2">
          ...
          <li className="text-[var(--text-primary)]">**Roster:** open **Admin → Roster** to see every nickname and real name, and fix either if it’s wrong. Each change is audit-logged. You can also set <strong>Pick backup</strong> (off, copy from a member, or auto 2025-rank team). JaJa copies Gams by default.</li>
...
| **Pick backup** | Optional: copy another member (30 min) or auto-pick the best remaining 2025-rank team (~2 min) if you still have no pick. |
