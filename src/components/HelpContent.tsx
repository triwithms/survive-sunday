    ...
    <article className="prose-survive space-y-6 text-sm leading-relaxed max-w-[68ch]">
      ...
      <section id="onboarding-first-run">
        ...
        <ul className="list-disc pl-5 space-y-1 text-[var(--text-muted)] mb-2">
          ...
          <li className="text-[var(--text-primary)]"><strong>Personal Join link</strong> from the commissioner (or the shared invite), then pick <strong>yourself from the live roster</strong> (nickname + real name). Join <strong>once</strong> with your own email and password — this attaches to your existing seat so your Week 1 picks stay with you. On that phone you should stay signed in. If that name is already claimed, the page says so and links you to <strong>Sign in</strong> (not a broken form). <strong>Don’t use Forgot password before you Join.</strong> After you Join, Forgot password and <strong>Email me a sign-in code</strong> only work with that same email. Returning BM Boys: tap <strong>Account</strong> in the header, then <strong>Change nickname</strong>. New joiners who are not on the list can join as a new player (unique nickname).</li>
      ...
      <section id="2-how-to-play-quick-start">
        ...
        <ol className="list-decimal pl-5 space-y-1 mb-2">
          <li>Open your <strong>personal Join link</strong> (or Join and enter invite code <code>SUNDAY26</code>). Pick <strong>your name</strong> from the roster, then set your own email and password — once. On this phone you should stay signed in. Returning BM Boys: your nickname and Week 1 picks stay on that seat — tap <strong>Account</strong> then <strong>Change nickname</strong> if you want something different. If the seat is already claimed, Sign in instead. Don’t use Forgot password before you Join. New joiners who are not on the list can create a unique nickname.</li>
