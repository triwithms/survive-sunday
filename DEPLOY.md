...
Short checklist for the free Hobby path. No paid add-ons required. Agent cost: see HANDOFF **#1 cost rule** (free Grok, then free Claude, then free Gemini — before any paid agents).
