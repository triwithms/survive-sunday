...
**Docs freshness:** Before free quota runs out on each free tier, update HANDOFF / FREE-GROK.md / FILE-MAP (Help only if a user/admin process changed) while still on that tier.
