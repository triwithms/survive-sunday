...
**Free tier order** before any paid Grok Bot / Cursor coding agents: **1. free Grok** → **2. then free Claude** → **3. then free Gemini**. Only after those free options are exhausted (or unsuitable for the task) open paid agents for the actual code PR/merge. Details: **[docs/HANDOFF.md](docs/HANDOFF.md)** (top) and **[docs/FREE-GROK.md](docs/FREE-GROK.md)** (free AI first).
