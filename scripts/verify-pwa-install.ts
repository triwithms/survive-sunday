...
const helpIntro = readFileSync("src/components/features/help/HelpIntro.tsx", "utf8");
const helpAccount = readFileSync("src/components/features/help/HelpAccount.tsx", "utf8");
assert.match(helpIntro, /A2hsIosHint/);
assert.match(helpAccount, /A2hsIosHint/);
assert.doesNotMatch(helpIntro, /bottom of Safari/);
assert.doesNotMatch(helpAccount, /bottom of Safari/);
