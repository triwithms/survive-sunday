/**
 * Manual/emergency schema helper — NOT a Vercel build step.
 * Do not wire this to `npm run build`.
 *
 *   tsx scripts/_dangerous/ensure-production-db.ts
 *
 * Localhost only unless ALLOW_PROD_DB_MUTATION=1. Vercel is always refused.
 *
...
assertNotProduction("ensure-production-db");
