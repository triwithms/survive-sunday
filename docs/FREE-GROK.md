...
This brief is for **free Grok** or a **basic paid Grok / xAI chat** (topic-split chats). It is **not** paid Grok Bot, Cursor desktop agents, or other expensive coding bots.
...
1. Specs, FILE-MAP lookups, QA critic scoring, copy, and checklists stay on **free Grok**.
...
6. Paid Grok Bot / Cursor coding agents: **actual code PR / merge only**, after the free-Grok plan is ready.
