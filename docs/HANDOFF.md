...
|------|--------|--------------------------------------------|
| Share Board / Scores as pictures | [PR #45](https://github.com/triwithms/survive-sunday/pull/45) (`cursor/board-scores-share-export-f6cc`) | **Share** on Board and Scores. Always includes the **full long picture**. Shorter options and split pages when the page is long. Save or Send. Help + this file. Does not touch picks / Join / Sign in / lock. |
