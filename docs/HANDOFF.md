...
|------|--------|--------------------------------------------|
| Videos: previews until kickoff, then highlights | [#54](https://github.com/triwithms/survive-sunday/pull/54) (until merge) | Previews for games that have not started (including DEN @ KC MNF). Highlights after kickoff / Final. NFL open-on-YouTube from #53 stays. |
